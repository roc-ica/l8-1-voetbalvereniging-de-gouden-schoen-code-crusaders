                ...
                <section class="SectionNewTask" id="SectionNewTask">
                    <div class="WrapperNewTask">
                        <form class="NewTaskForm" id="NewTaskForm">
                            <button type="reset" class="CloseButton" id="NewTaskClose">X</button>
...
<script>
    ...
    var taskSection = document.getElementById("SectionNewTask");
    var taskForm = document.getElementById("NewTaskForm");
    var confirm = document.getElementById("NewTaskFormSubmit")
    var cancel = document.getElementById("NewTaskClose")
    ...
    async function WaitClickEdit() {
        const promise = new Promise((resolve, reject) => {
            taskForm.addEventListener('submit', function(e) {
                ...
                if ((document.getElementById("StartTaskDate").value <= document.getElementById("EndTaskDate").value && timeCorrect) || dateCorrect) {
                    resolve();
                } else {
                    reject();
                }
        ...
        return await promise
            .then(() => {
                ...
                fetch("../Media/Fetch/CreateTask.php", {
                        method: "POST",
                        headers: {
    ...
    async function WaitClickCreate() {
        const promise = new Promise((resolve, reject) => {
            taskForm.addEventListener('submit', function(e) {
                var dateCorrect = false;
                var timeCorrect = false;
